...
//	private static final String path = SemanticConstants.DEFAULT_ONTOLOGY_PATH.replaceFirst("file:", "");
	
	//TODO the files need to be copied to the execution path of openhab (same folder where the start.sh is located)
	public LocationMapperCustom() {
//		writeToFileIfNotExist();
	...
	public void addLocalPathsToDefaultLocationMapper(){				
		...
		addAltEntry("http://elite.polito.it/ontologies/dogont.owl", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "dogont.owl");
		addAltEntry("http://purl.org/NET/muo/ucum/", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "ucum.ttl");
		addAltEntry("http://purl.org/NET/muo/muo-vocab.owl/", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "muo-vocab.owl.ttl");
...
//		addAltEntry("http://creativecommons.org/ns", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "creativecommons-ns.rdf");
//		addAltEntry("http://protege.stanford.edu/plugins/owl/protege", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "protege.owl");
//		addAltEntry("http://xmlns.com/foaf/0.1/", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "xmlns-foaf-rdf");
//		addAltEntry("http://www.owl-ontologies.com/2005/08/07/xsp.owl", SemanticConstants.DEFAULT_ONTOLOGY_PATH + "xsp.owl");
